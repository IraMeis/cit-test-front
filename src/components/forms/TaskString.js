...
const TaskString = () => {
    ...
    return (
        <div>
            ...
            <h6>Для каждого элемента массива строк А1 определяется, является ли эта строка
                подстрокой любого из элементов массива А2. В результирующий массив попадают
                уникальные подстроки из А1 в лексикографическом порядке.</h6>
